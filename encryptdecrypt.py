...
# App Key and Secret obtained from the Dropbox developer website
	app_key = 'gxo231dhf1qvpg8'
	app_secret = 'epf2kxv2wjzwt5k'
	flow = dropbox.client.DropboxOAuth2FlowNoRedirect(app_key, app_secret)
	access_token = "njbjjOJ4-M0AAAAAAAAJRRCfatkXKdgCbIIY1TVyjtjjYthhwz17vN-LLXq8y0_D"
...
if choice == 'A':
		...
		CLIENT_ID = '1051781097706-v7lic7fr3g6il7ns22h2jrgfgp3tf897.apps.googleusercontent.com'
		CLIENT_SECRET = 'LRxVqIMPb6U6BsFuOkmir96o'
		...
		#Uploading to Google Drive
                CLIENT_ID = '1051781097706-rihhncvt1ovpu49ir31lhv680fua9vhr.apps.googleusercontent.com'
		CLIENT_SECRET = '-Ad1xRDr_BRx1g59CVmS3fav'
		# Checking https://developers.google.com/drive/scopes for all available scopes
		OAUTH_SCOPE = 'https://www.googleapis.com/auth/drive'
		REDIRECT_URI = 'https://www.example.com/oauth2callback'
		# Run through the OAuth flow and retrieve credentials
